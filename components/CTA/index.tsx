          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Sky Rocket Your Productivity with SkyPOS
              </h2>
              <p>
                Download our SkyPOS BackOffice mobile app and sign up to join SkyPOS 360. Sign Up early and enjoy 1 month free Subscription.
              </p>
            </motion.div>
            <motion.div
              variants={{
